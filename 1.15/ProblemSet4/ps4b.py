...
def isCompValidWord(word, hand): #THIS IS ***CRUCIAL*** TO HAVE THIS MODIFIED
#VERSION OF isValidWord BECAUSE IT TAKES ***TOO LONG*** IF wordList IS PASSED
#AND REMEMBER TO CHANGE FUNCTION CALL IN compChooseWord
    """
...
def compChooseWord(hand, wordList, n):
    ...
    for i in wordList:
        ...
        if isCompValidWord(i, hand) == True:
#        if ValidWord(word, hand, wordList) == True:
...
#                        print 'going to compPlayHand'
                    ...
                    if player != 'u' and player != 'c':
                        print 'Invalid command.'
        elif choice != 'e' and choice != 'n' and choice != 'r':
            print 'Invalid command.'
